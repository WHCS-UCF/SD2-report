...
The NRF requires 3.3v of electricity to operate so all parts of WHCS 
...
Usage of the NRF driver involves first constructing the class by telling
...
To get the microcontrollers running, the code we write needed to be programmed
...
To make this a reality, we chose the versatile, premade, and well
...
The design for the WHCS application involved making sure that performing the
...
\ucfgfx[scale=0.50]{fig:android-gui}{GUI_FLOW.png}{Android GUI Layout}
...
The 3.3V line will stem out from the 5V line as shown in
...
\ucfgfx[trim=3in 4.75in 3.1in 2.2in,clip,width=0.9\textwidth]
{fig:pwr-sch-ac-rect}{power-board.pdf}{Power board AC rectification}
...
% DC-DC
\ucfgfx[trim=3in 2.75in 2.1in 3.72in,clip,width=0.9\textwidth]
{fig:pwr-sch-ac-rect2}{power-board.pdf}{Power board AC rectification}
...
\begin{figure}[H]
\makebox[\linewidth][c] {
  \includegraphics[width=0.45\linewidth]{board-shots/PB_Front}
  \includegraphics[width=0.45\linewidth]{board-shots/PB_Back}
}
...
\begin{figure}[H]
\makebox[\linewidth][c] {
  \includegraphics[width=0.45\linewidth]{board-shots/base-station-front}
  \includegraphics[width=0.45\linewidth]{board-shots/base-station-back}
}
...
The temperature sensor that we decided to use for WHCS was the TMP36. The
...
\begin{figure}[H]
\makebox[\linewidth][c] {
  \includegraphics[width=0.45\linewidth]{board-shots/control_module_v1_1_front.png}
  \includegraphics[width=0.45\linewidth]{board-shots/control_module_v1_1_back.png}
}
