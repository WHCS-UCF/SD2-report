...
possible. Given this, the BS is the least point of failure for the WHCS system.
...
\paragraph{Software Flow Breakdown}
...
would bring up all of the main modules (radio, LCD, bluetooth, and UART). Once
all of these modules are inited correctly, the BS would begin the main loop.
...
response packets would be generated and sent. 
...
ones (essentially a derived object from the generic control module.) The
details of the network structure that would enable this clean interface is
